...
const B = "object" == typeof self ? self.FormData : window.FormData;
function F(e) {
...
const k = N.toFlatObject(N, {}, null, function (e) {
...
function z(e, t, n) {
  ...
  function l(e, n, o) {
    ...
    return !!F(e) || (t.append(L(o, n, s), u(e)), !1);
  }
  const f = [],
    d = Object.assign(k, {
      defaultVisitor: l,
          ...
          N.forEach(n, function (n, s) {
            !0 ===
              (!(N.isUndefined(n) || null === n) &&
                o.call(t, n, N.isString(s) ? s.trim() : s, r, d)) &&
              e(n, r ? r.concat(s) : [s]);
          }),
          f.pop();
      }
...
const K = class {
  ...
  W = "undefined" != typeof URLSearchParams ? URLSearchParams : I,
  $ = FormData,
  X = (() => {
    let e;
    return (
  ...
  Q = {
    isBrowser: !0,
    classes: { URLSearchParams: W, FormData: $, Blob: Blob },
...
function Z(e) {
  function t(e, n, r, o) {
    ...
    const i = Number.isFinite(+s),
      a = o >= e.length;
    if (((s = !s && N.isArray(r) ? r.length : s), a))
      return N.hasOwnProp(r, s) ? (r[s] = [r[s], n]) : (r[s] = n), !i;
    (r[s] && N.isObject(r[s])) || (r[s] = []);
    return (
      t(e, n, r[s], o) &&
        N.isArray(r[s]) &&
        (r[s] = (function (e) {
...
const G = Q.isStandardBrowserEnv
  ? {
...
const ee = Q.isStandardBrowserEnv
  ? (function () {
...
N.inherits(te, _, { __CANCEL__: !0 });
const ne = N.toObjectSet([
    "age",
    "authorization",
    "content-length",
    "content-type",
...
function se(e) {
  return !1 === e || null == e ? e : N.isArray(e) ? e.map(se) : String(e);
}
function ie(e, t, n, r) {
...
class ae {
  ...
  set(e, t, n) {
    ...
    const s = (e, t) => N.forEach(e, (e, n) => o(e, n, t));
    return (
      N.isPlainObject(e) || e instanceof this.constructor
        ? s(e, t)
        : N.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z]+$/.test(e.trim())
        ? s(
            ((e) => {
              const t = {};
              let n, r, o;
  ...
  toJSON(e) {
    ...
    return (
      N.forEach(this, (n, r) => {
        null != n && !1 !== n && (t[r] = e && N.isArray(n) ? n.join(", ") : n);
      }),
      t
    );
  }
...
function le(e) {
  return new Promise(function (t, n) {
    ...
    N.isFormData(r) && Q.isStandardBrowserEnv && o.setContentType(!1);
    ...
    if (
      (c.open(e.method.toUpperCase(), H(u, e.params, e.paramsSerializer), !0),
      (c.timeout = e.timeout),
      "onloadend" in c
        ? (c.onloadend = l)
      ...
      (c.ontimeout = function () {
        ...
        e.timeoutErrorMessage && (t = e.timeoutErrorMessage),
          n(
            new _(t, r.clarifyTimeoutError ? _.ETIMEDOUT : _.ECONNABORTED, e, c)
          ),
          (c = null);
      }),
    ...
    void 0 === r && o.setContentType(null),
      "setRequestHeader" in c &&
        N.forEach(o.toJSON(), function (e, t) {
      ...
      "function" == typeof e.onDownloadProgress &&
        c.addEventListener("progress", ue(e.onDownloadProgress, !0)),
      "function" == typeof e.onUploadProgress &&
        c.upload &&
        c.upload.addEventListener("progress", ue(e.onUploadProgress)),
      (e.cancelToken || e.signal) &&
        ((i = (t) => {
          c &&
            (n(!t || t.type ? new te(null, e, c) : t), c.abort(), (c = null));
        }),
...
const fe = { http: le, xhr: le },
  de = (e) => {
    ...
    if (!N.isFunction(e)) throw new TypeError("adapter is not a function");
    return e;
  },
  ...
  transformRequest: [
    function (e, t) {
      const n = t.getContentType() || "",
        ...
        o = N.isObject(e);
      o && N.isHTMLForm(e) && (e = new FormData(e));
      if (N.isFormData(e)) return r && r ? JSON.stringify(Z(e)) : e;
      if (
        N.isArrayBuffer(e) ||
        N.isBuffer(e) ||
        N.isStream(e) ||
      ...
      if (o) {
        ...
        if ((s = N.isFileList(e)) || n.indexOf("multipart/form-data") > -1) {
          const t = this.env && this.env.FormData;
          return z(s ? { "files[]": e } : e, t && new t(), this.formSerializer);
        }
      }
      return o || r
...
function Ee(e) {
  ...
  return (e.adapter || me.adapter)(e).then(
    function (t) {
      return (
        be(e),
...
function Oe(e, t) {
  ...
  return (
    N.forEach(Object.keys(e).concat(Object.keys(t)), function (r) {
      const s = c[r] || o,
        i = s(e[r], t[r], r);
      (N.isUndefined(i) && s !== a) || (n[r] = i);
    }),
    n
  );
}
...
Se.transitional = function (e, t, n) {
  function r(e, t) {
    return (
      "[Axios v1.2.0-alpha.1] Transitional option '" +
      e +
      "'" +
      t +
      (n ? ". " + n : "")
...
class je {
  ...
  request(e, t) {
    ...
    void 0 !== n &&
      ...
      (s = o && N.merge(o.common, o[t.method])),
      s &&
        N.forEach(
  ...
  getUri(e) {
    return H(
      Y((e = Oe(this.defaults, e)).baseURL, e.url),
      e.params,
      e.paramsSerializer
    );
  }
...
const Ne = (function t(n) {
  ...
  return (
    N.extend(o, xe.prototype, r, { allOwnKeys: !0 }),
    N.extend(o, r, null, { allOwnKeys: !0 }),
    (o.create = function (e) {
      return t(Oe(n, e));
    }),
    o
...
(Ne.Axios = xe),
  ...
  (Ne.AxiosHeaders = ce),
  (Ne.formToJSON = (e) => Z(N.isHTMLForm(e) ? new FormData(e) : e)),
  (Ne.default = Ne);
const _e = Ne,
  {
    Axios: Pe,
